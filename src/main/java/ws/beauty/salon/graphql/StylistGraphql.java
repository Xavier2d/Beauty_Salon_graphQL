...
public class StylistGraphql {
    ...
    @QueryMapping
    public List<StylistResponse> findAllStylist() {
        return service.findAll();
    }

    //  Query: obtener estilista por ID
    @QueryMapping
    public StylistResponse findByIdStylist(@Argument Integer idStylist) {
        return service.findById(idStylist);
    }

    //  Mutation: crear nuevo estilista
    @MutationMapping
    public StylistResponse createStylist(@Valid @Argument StylistRequest req) {
        return service.create(req);
    }

    // Mutation: actualizar estilista
    @MutationMapping
    public StylistResponse updateStylist(@Argument Integer idStylist, @Valid @Argument StylistRequest req) {
